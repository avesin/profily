...
const sectionsNew = () => {
  return (<div id="resume-content" className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-lg border border-gray-200">
      {/* Contact Section */}
    ...
    <div className="mb-8">
      ...
      <div className="mt-6">
        ...
        <p className="text-gray-600 text-sm">Mobile Engineer (Feb 2017 - Mar 2019) · Yogyakarta, Indonesia</p>
          ...
          <li className="flex items-start">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 mt-2 text-sm">
                <li>Build Agio Mobile App – React Native</li>
                <li>Build Dparagon Mobile App – React Native</li>
                <li>Build CiApps and FiApps Mobile App – iOS (Swift)</li>
                <li>Fix and add features to Persib Mobile App – Android</li>
              </ul>
            </div>
          </li>
        </ul>
      ...
      <div className="mt-6">
        ...
        <p className="text-gray-600 text-sm">Mobile Developer (Dec 2014 - Jan 2017) · Yogyakarta, Indonesia</p>
        <ul className="mt-2 space-y-2 text-gray-700">
          <li className="flex items-start">
            <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-2"></span>
            <div>
              <p>Developed and maintained mobile applications for iOS and Android (DompetSehat and Veryfund) along with backend systems using Laravel for financial services.</p>
      ...
      <div className="mt-6">
        <h3 className="text-xl font-semibold text-gray-800">JAVASIGN</h3>
        <p className="text-gray-600 text-sm">Backend Programmer (Jan 2014 - Dec 2014) · Yogyakarta, Indonesia</p>
        <ul className="mt-2 space-y-2 text-gray-700">
          <li className="flex items-start">
            <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-2"></span>
            <div>
              <ul className="list-disc pl-6 text-sm">
                <li>Build Company Attendance Website (Frontend & Backend) – Laravel Framework</li>
                <li>Add new features to the Company HRD Website – CodeIgniter Framework</li>
                <li>Build Backend for Quantum Job – CodeIgniter Framework</li>
                <li>Build Backend for Jogja Datsun – Laravel Framework</li>
                <li>Develop Fujiro Mobile App (Android) along with its webservice</li>
                <li>Develop Kesles Mobile App (Android) along with its webservice</li>
                <li>Build Zettamedia Website</li>
              </ul>
            </div>
          </li>
        </ul>
      ...
      {/* PR Rabiha Pilar */}
      <div className="mt-6">
        <h3 className="text-xl font-semibold text-gray-800">PR Rabiha Pilar</h3>
        <p className="text-gray-600 text-sm">Junior Web Developer (Jan 2014 - Nov 2014)</p>
        <ul className="mt-2 space-y-2 text-gray-700">
          <li className="flex items-start">
            <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-2"></span>
            <div>
              <p>I was under contract for 6 months, but after 5 months, because I will continue my studies, the contract was not extended.</p>
            </div>
          </li>
        </ul>
      </div>
  ...
  return (
    <div id="resume-content" className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-lg border border-gray-200">
      ...
      <div className="mb-8">
        ...
        <div className="mt-6">
          <h3 className="text-xl font-semibold text-gray-800">Indiva Finansia Teknologi</h3>
          <p className="text-gray-600 text-sm">Mobile Developer (Dec 2015 - Jan 2016)</p>
          <ul className="mt-2 space-y-2 text-gray-700">
            <li className="flex items-start">
              <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-2"></span>
              <div>
        ...
        <div className="mt-6">
          ...
          <p className="text-gray-600 text-sm">Web Developer (April 2013 - Octo 2013)</p>
          <ul className="mt-2 space-y-2 text-gray-700">
            <li className="flex items-start">
              <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-2"></span>
              <div>
